...
*/
    ...
    "load": function () {
       ...
       // linkElement.href = cdn + 'css/tarteaucitron.css?v=' + tarteaucitron.version;
          //linkElement.href =  '/Scripts/gdpr/css/tarteaucitron.css?v=' + tarteaucitron.version;
        ...
        tarteaucitron.addScript(pathToLang, '', function () {
            tarteaucitron.addScript(pathToServices, '', function () {
                ...
                if (defaults.highPrivacy) {
                    ...
                    html += '<div id="tarteaucitronAlertBig" class="tarteaucitronAlertBig' + orientation + '"><div class="wrap">';
                    html += '   <span id="tarteaucitronDisclaimerAlert">';


                    html += '   ' +  document.getElementById("gdprshow").innerHTML;   //desc content
                    html += '   </span>';
                    html += '   <span id="tarteaucitronPersonalize" class="btn btn-primary" onclick="tarteaucitron.userInterface.respondAll(true);chkagree();">';


                    html += '       ' +  document.getElementById("gdprshowbtn").innerHTML; //button
                    html += '   </span>';
                ...
                if((document.getElementById("chkgdpr").value)=="agree"){
